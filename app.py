...
amount_tuna = st.number_input("Kerjuk adja meg a heten elfogyasztasra szant tonhal mennyiseget mg-ban!")

bodyweight = st.number_input("Kerjuk adja meg testomeget kg-ban!")

healthy_amount_of_mercury_for_Reka = bodyweight * 0.1

amount_of_mercury_in_1mg_tuna = 0.012

if (amount_tuna != 0) and (bodyweight != 0):
    if (amount_tuna * amount_of_mercury_in_1mg_tuna) < healthy_amount_of_mercury_for_Reka:
